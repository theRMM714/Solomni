...
pub const ROUTES: &[Route] = &[
    ...
    Route {
        ...
        capability: "RegistryOps::remove_model / set_core_model / probe_model_tools",
        request: "—",
        response: "{ok} / {ok,outcome,detail,mode}",
        statuses: &[200, 400, 404],
        note: "动作：remove / core（设为核心默认）/ probe（实测原生工具调用，结论写回登记处）",
    },
    Route {
        id: "agent.new",
        method: "POST",
